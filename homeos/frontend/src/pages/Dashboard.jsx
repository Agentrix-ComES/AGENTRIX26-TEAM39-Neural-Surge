...
import { generatePlan, getPantry } from '../services/api';
...
export default function Dashboard({ onPlanGenerated, currentPlan }) {
  ...
  const runSimulation = async () => {
    ...
    const agentSteps = [
      ...
      'Meal Planner Agent: Structuring 7-day plan draft...',
      'Budget Agent: Scoring ingredient market costs...',
      'Reflection Agent: Checking constraints...',
      'Reflection loop failed on first iteration: budget exceeded LKR 10,000.',
      'Self-correction: Substituting high-cost items.',
    ...
    <div className="flex-1 overflow-y-auto p-8 max-w-6xl mx-auto">
      ...
      <div className="mb-10 text-center md:text-left">
        ...
        <h1 className="text-4xl font-extrabold tracking-tight mt-3 text-white leading-tight">
          Plan your week. <span className="grad-text">Optimize your budget.</span>
        </h1>
        <p className="text-slate-400 max-w-2xl mt-3 text-sm leading-relaxed">
          HomeOS analyzes pantry inventory, calculates waste scores, searches local recipe databases, and runs self-correction reflection loops to optimize household economics.
        </p>
      </div>
      ...
      <div className="flex flex-col items-center gap-3 mb-12">
        ...
        >
          ...
          {isLoading ? 'Running Intelligent Agents...' : 'Generate Economic Plan'}
        </button>
      ...
      {currentPlan && !isLoading && (
        <div>
          ...
          <div className="mb-10">
            <h3 className="font-extrabold text-xl text-white mb-6">Weekly Meal Schedule</h3>
